...
func main() {
	// 建立数据库连接
	dsn := "root:wj651213@tcp(127.0.0.1:3306)/douyindemo?charset=utf8mb4&parseTime=True&loc=Local" // TODO: 从配置文件中读取
	...
	// 自动迁移数据结构
	err = db.AutoMigrate(&controller.User{}, &controller.Video{}, &controller.Comment{})
	if err != nil {
